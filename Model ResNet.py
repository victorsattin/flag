        ...
        for img_name in os.listdir(in_path):
            ...
            try:
                ...
                if class_name in bad_classes:
                    n_aug = 5
                    aug_transform = strong_augmentation
                else:
                    n_aug = 1
                    aug_transform = light_augmentation
...
LAST_MODEL_PATH = "last_resnet_model.pth"
...
print(
    ...
    f"{checkpoint.get('best_val_acc', 'N/A')}"
)
...
print(f"Best ResNet Val Acc: {best_val:.4f}")

print(f"ResNet Accuracy: {accuracy:.4f}")

print(
    f"ResNet Precision (macro): "
    f"{precision_macro:.4f}"
)

print(
    f"ResNet Recall (macro): "
    f"{recall_macro:.4f}"
)

print(
    f"ResNet F1-score (macro): "
    f"{f1_macro:.4f}"
)
